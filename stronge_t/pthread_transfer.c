...
int file_env_info_a9_zigbee(struct env_info_client_addr *rt_status,int home_id)
{
	...
	rt_status->monitor_no[home_id].zigbee_info.type  		= 'z';
	...
	rt_status->monitor_no[home_id].a9_info.type  	= 'a';
...
int	get_sensor_data_from_a9(struct makeru_a9_info* a9_sensor_data)
{
	...
	/*Ô¤Ìî³ä£¬ÓÐµãÀË·Ñ¿Õ¼ä£¬´ó¼Ò¿ÉÒÔÓÅ»¯Ò»ÏÂ*/
	a9_sensor_data->adc = (1.8 * adc_sensor_data)/4096 * 100; //¶¨ÒåÎ´int32,Ó¦¸ÃÊÇfloat,·Å´ó100±¶£¬±£»¤Ð¡ÊýÎ»
